...
contract TSwapPool is ERC20 {
    ...
    // @written-info event parameters could/should be indexed (if there are more than 3 params?)
    ...
    function deposit(
        ...
        // if someone sets a deadline, "next block"
        // they could still deposit
        // IMPACT: a user who expects a deposit to fail will go through. Severe disruption of functionality
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            // @written-info/gas don't need this line
            ...
            // e if we calculate too many pool tokens to deposit, we rever
            // deposit 10 WETH
            ...
            // @written-info - it would be better if this update was before the `_addLiquidityMintAndTransfer` call
            // which
            // includes external calls, to follow CEI
        ...
        private
    {
        ...
        // @written-low event params are wrong order and should be
        // (msg.sender, wethToDeposit, poolTokensToDeposit)
        // IMPACT: Low - protocol is giving the wrong return/info
        // LIKELIHOOD: HIGH
        ...
        revertIfZero(minPoolTokensToWithdraw)
    {
        ...
        // q is this _burn external?
        // a no, it's inherited from ERC20 and part of (this) contract
        ...
        returns (uint256 outputAmount)
    {
        ...
        // @written-info magic numbers should be constants
        // 0.03% fee for LPs
        // @written 997 / 1000
    ...
    // @written-info functions not used internally could be marked external
    // @written-info where is the natspec?
    function swapExactInput(
        IERC20 inputToken, // e input token to swap / sell
        uint256 inputAmount, // e amount of input token to sell
        IERC20 outputToken, // e output token to buy
        ...
        returns (uint256 inputAmount)
    {
        ...
        // no slippage protectio
        // @written need a maxInputAmount

        // IMPACT: HIGHT -> a user may get a way worse swap
    ...
    function sellPoolTokens(uint256 poolTokenAmount) external returns (uint256 wethAmount) {
        // @written this is wrong - swapExactOutput is expecting amount for output token which is i_wethToken
