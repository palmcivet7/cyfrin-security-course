...
contract ThunderLoan is Initializable, OwnableUpgradeable, UUPSUpgradeable, OracleUpgradeable {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    // e maps deposited underlying token to its asset equivalent? ie USDC -> USDCAssetToken
    ...
    // e probably a mapping that tells us if a token is currently being used for a flash loan
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // @audit-info change tswapAddress to poolFactoryAddress ?
    // q what happens if we deploy the contract, and someone else initializes it?
    // a they could pick a different tswapAddress
    ...
    function deposit(IERC20 token, uint256 amount) external revertIfZero(amount) revertIfNotAllowedToken(token) {
        ...
        // @written-written
        // we shouldnt be updating the exchange rate here!
        ...
        revertIfNotAllowedToken(token)
    {
        ...
        // e this is probably the fe of the flash loan
        ...
        // @followup reentrancy
        // @followup do we need the return value of functionCall?
    ...
    // @audit-low you cant use repay to repay a flash loan inside another flash loan
    ...
    function setAllowedToken(IERC20 token, bool allowed) external onlyOwner returns (AssetToken) {
        if (allowed) {
            ...
            // q what if they dont have a name?
            ...
            AssetToken assetToken = s_tokenToAssetToken[token];
            delete s_tokenToAssetToken[token]; // q does deleting a mapping work correctly? // a yes
            emit AllowedTokenSet(token, assetToken, allowed);
            return assetToken;
        }
    }
    ...
    // qanswered is this calculating the fees of flash loans?
    // a yes
    ...
    function getCalculatedFee(IERC20 token, uint256 amount) public view returns (uint256 fee) {
        ...
        // q @audit-follow is this correct?
        ...
        // 1 USDC + 0.003 USDC???
        // @audit
        // IMPACT prices are wrong -> medium/hihg
        // LIKELIHOOD -> high because every fee will be affects
    ...
    function updateFlashLoanFee(uint256 newFee) external onlyOwner {
        ...
        // @audit-low this function should emit an event
